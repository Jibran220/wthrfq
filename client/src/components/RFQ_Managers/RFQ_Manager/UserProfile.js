...
import ChatContainer from "../../ComponentsForAdmin";
              ...
              <Card.Body>
                <div className="d-flex flex-wrap align-items-center justify-content-between">
                  ...
                  >
                    ...
                    <Nav.Item as="li">
                      <Nav.Link eventKey="fourth"onClick={pdfGenerator}>P.O</Nav.Link>
                    </Nav.Item>
                  </Nav>
                </div>
              </Card.Body>
          ...
          {currentChat === undefined ? (
            ...
            <ChatContainer currentChat={currentChat} socket={socket} />
              ...
              <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <div className="header-title">
                                    <h4 className="card-title">Compase Email</h4>
                                </div>
                            </Card.Header>
                            <Card.Body>
                                <p>Write the Email to the the Vendor that he is selected for P.O.</p>
                                <Form>
                                {data.map((item) => (
                                   <Form.Group className="form-group">
                                    ...
                                    <Form.Group className="form-group">
                                        <Form.Label  htmlFor="exampleInputText1">Subject: </Form.Label>
                                        <Form.Control type="text"  id="exampleInputText1"  placeholder="Subject" name="subject" value={sendpo.subject} onChange={inputhandeler}/>
                                    </Form.Group>
                                    <Form.Group className="mb-3 form-group">
                                        <Form.Label  htmlFor="exampleFormControlTextarea1"> Body:</Form.Label>
                                        <Form.Control as="textarea"  id="exampleFormControlTextarea1" rows="5"  name="body"value={sendpo.body} onChange={inputhandeler}/>
                                    </Form.Group>
                                    <Form.Group>
              ...
              <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <div className="header-title">
                                    <h4 className="card-title">Compose Email</h4>
                                </div>
                            </Card.Header>
                            <Card.Body>
                                <p>Write the Email to the the Vendor that he is selected for P.O.</p>
